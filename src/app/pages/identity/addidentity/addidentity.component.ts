...
@Component({
  ...
  styleUrl: './addidentity.component.scss'
})
...
readonly data = inject<any>(MAT_DIALOG_DATA);
     ...
     constructor(private formBuilder:FormBuilder,
       ...
       private dialogRef: MatDialogRef<AddidentityComponent>) {
     }
     ...
     ngOnInit(): void {
       ...
       configForm(){
         this.reasonForm = new FormGroup({
          identity_type: new FormControl(null, Validators.required),
  ...
  if (this.reasonForm.valid) {
    ...
    this.identityService.addIdentity(formData).subscribe(
      (response: any) => {
    ...
    Swal.fire({
      ...
      confirmButtonText: 'OK',
       ...
       updateIdentity(){
         if(this.reasonForm.valid){
          this.identityService.updateIdentity(this.reasonForm.value, this.reasonData.reason_id).subscribe(response=>{
